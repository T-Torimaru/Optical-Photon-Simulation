...
G4ThreadLocal G4Allocator<OpNoviceScintHit>* OpNoviceScintHitAllocator;
//G4ThreadLocal G4Allocator<OpNoviceScintHit>* OpNoviceScintHitAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

OpNoviceScintHit::OpNoviceScintHit(G4int i,G4double t)
...
OpNoviceScintHit::OpNoviceScintHit(const OpNoviceScintHit &right)
: G4VHit() {
    fId = right.fId;
    fTime = right.fTime;
    fPos = right.fPos;
...
int OpNoviceScintHit::operator==(const OpNoviceScintHit &/*right*/) const
{
    return 0;
}
...
const std::map<G4String,G4AttDef>* OpNoviceScintHit::GetAttDefs() const
{
    G4bool isNew;
    std::map<G4String,G4AttDef>* store
    = G4AttDefStore::GetInstance("OpNoviceScintHit",isNew);
...
std::vector<G4AttValue>* OpNoviceScintHit::CreateAttValues() const
{
